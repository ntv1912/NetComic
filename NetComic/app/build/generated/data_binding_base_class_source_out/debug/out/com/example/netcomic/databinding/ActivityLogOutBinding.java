...
public final class ActivityLogOutBinding implements ViewBinding {
  ...
  public static ActivityLogOutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_log_out, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityLogOutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogOutBinding((ConstraintLayout) rootView, btnLogout, profile);
    }
